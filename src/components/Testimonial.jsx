...
export default function Testimonials() {
  return (
    <div className="relative flex max-w-[100vw] overflow-hidden py-5">
      ...
      <div className="pointer-events-none absolute inset-y-0 left-0 w-1/3 bg-gradient-to-r from-white dark:from-neutral-900"></div>
      <div className="pointer-events-none absolute inset-y-0 right-0 w-1/3 bg-gradient-to-l from-white dark:from-neutral-900"></div>
    </div>
  )
}
