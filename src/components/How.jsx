      ...
      <div className="mx-auto mt-16 sm:mt-20 lg:mt-24 lg:max-w-none">
        <div className="grid max-w-xl grid-cols-1 gap-6 lg:max-w-none lg:grid-cols-3">
          {features.map((feature) => (
            <div key={feature.name} className="border rounded-lg border-white/10 p-4 hover:border-white/20 hover:bg-white/5 transition duration-300">
              <div className="flex items-center">
                <div className="rounded border border-white/5 bg-white/5 p-1">
                  {feature.image}
                </div>
                <div className="ml-4 text-lg font-medium text-neutral-900 dark:text-neutral-100">{feature.name}</div>
              </div>
