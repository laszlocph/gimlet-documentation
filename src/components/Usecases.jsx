export function Dropdown() {
  return (
    <div className="group relative dropdown cursor-pointer">
      ...
      <div className="group-hover:block -my-2 dropdown-menu absolute hidden h-auto -right-1/2 p-6 rounded-3xl backdrop-blur-3xl bg-zinc-900/30 ring-1 ring-white/10" id="headlessui-popover-panel-:r1h:" tabIndex="-1" data-headlessui-state="open">
        <ul className="divide-y divide-zinc-100 top-0 w-48 text-base divide-zinc-100/5 text-zinc-300">
