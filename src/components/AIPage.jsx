          ...
          <div className="text-base leading-7 text-zinc-900 dark:text-white space-y-8">
            ...
            <div className="mt-10 max-w-2xl">
              ...
              <ul>
                <li>
                  <span>
                    <strong className="font-semibold">Hybrid Cloud Compatibility:</strong> Deploy and manage models across hybrid, cloud, and on-premises environments.
                  </span>
                </li>
                <li>
                  <span>
                    <strong className="font-semibold">Optimized Resource Allocation:</strong> Kubernetes to automatically scale your infrastructure to match your model&apos;s demands.
                  </span>
                </li>
              </ul>
            </div>
            <div className="mt-10 max-w-2xl">
              ...
              <ul>
                <li>
                  <span>
                    <strong className="font-semibold">Centralized Version Control:</strong> Track, preview, and deploy your model versions with ease.
                  </span>
                </li>
                <li>
                  <span>
                    <strong className="font-semibold">Advanced Deployment Capabilities:</strong> Rollbacks and automated deployments to even hundreds of models.
                  </span>
                </li>
              </ul>
            </div>
            <div className="mt-10 max-w-2xl">
              ...
              <ul>
                <li>
                  <span>
                    <strong className="font-semibold">Grafana & Prometheus Compatibility:</strong> Real-time data of infrastructure performance.
                  </span>
                </li>
                <li>
                  <span>
                    <strong className="font-semibold">Fine-Tune Your Infrastructure:</strong> Identify and address performance bottlenecks based on monitoring data.
                  </span>
                </li>
              </ul>
            </div>
